          ...
          totalizateLogic.totalizateClientCart(req.body,function(prod){
              ...
              quotationsModel.create(prod,null,function(newQuot){
                ...
                // agregar que la referencia se creee de buena manera
                  currentMethods['payU'].configBody(prod,personaPrueba,newQuot.reference,function(paymentData){


                      res.status(200).send({message:'creado con exito',data:paymentData.data,type:paymentData.type});
